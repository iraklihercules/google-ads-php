...
class V19Client
{
    ...
    public function __construct(
        private readonly AdWordsServiceBuilder $adWordsServiceBuilder,
    ) {
    }
    ...
    private function getReport(string $clientId, string $query, bool $summaryRow = false): ?PagedListResponse
    {
        ...
        // Limit page size to 1000 to avoid large responses and reduce risk of connection drops
        $args['pageSize'] = 1000;
...
$serviceBuilder = new AdWordsServiceBuilder($googleCredentialsFile);
